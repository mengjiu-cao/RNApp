...
class SettingPage: UIViewController {
  ...
  public override func viewDidLayoutSubviews() {
    ...
    web3ConnectionSection.pin.left(16).right(16).below(of: web3ConnectionLbl).height(70 * 2).marginTop(12)
    
    accountLbl.pin.left(16).below(of: web3ConnectionSection).marginTop(20).sizeToFit()
    accountSection.pin.left(16).right(16).below(of: accountLbl).height(70 * 2).marginTop(12)
    
    supportLbl.pin.left(16).below(of: accountSection).marginTop(20).sizeToFit()
    supportSection.pin.left(16).right(16).below(of: supportLbl).height(70 * 2).marginTop(12)
    
    aboutLbl.pin.left(16).below(of: supportSection).marginTop(20).sizeToFit()
    aboutSection.pin.left(16).right(16).below(of: aboutLbl).height(70 * 2).marginTop(12)
